...
package com.github.tvdtb.mediasource;

import com.github.tvdtb.mediasource.beans.HelloWorldBean;
import com.github.tvdtb.mediasource.browser.boundary.BrowserBoundary;
import com.github.tvdtb.mediasource.configuration.SpringConfig;
import com.github.tvdtb.mediasource.rest.Hateoas;
import com.github.tvdtb.mediasource.rest.HateoasEntity;
import com.github.tvdtb.mediasource.rest.HateoasRegistry;
 ...
 */
@ServiceEndpoint(port = 8080,contextRoot = "/media/api/browser/")
@SpringVerticle(springConfig = SpringConfig.class)
public class BrowserResource extends VxmsEndpoint {
    @Inject
    ...
    public static void main(String[] args) {
        ...
        Vertx.vertx().deployVerticle(BrowserResource.class.getName(), options);
    }
}
